...
function constructPromptAndGrammerFromList(data) {
  var prompt;
  var grammer = [];
...
module.exports = {get_message, get_intention, INTENTION_UNKOWN, global_messages, constructPromptAndGrammerFromList};